...
void VulkanEngine::init_swapchain()
{
    ...
    drawImageUsages |= VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT; // can use graphics pipelines to draw geometry into it
...
{
    init_gradient_pipelines();
}

void VulkanEngine::init_gradient_pipelines()
{
